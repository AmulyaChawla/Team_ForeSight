...
dir = "https://github.com/AmulyaChawla/Team-Foresight/tree/main/food_from_fridge-main/"

st.set_page_config(
    page_title="Team Foresight",
    page_icon=':pizza:'
)
...
#file = os.path.join(dir, 'data/','food_250.csv')
data = fetch_and_clean_data ('D:\\food_from_fridge-main\\data\\food_250.csv')
...
with st.sidebar.expander("Source Code"):
    st.write("https://github.com/AmulyaChawla/Team-Foresight/tree/main/food_from_fridge-main/data")
